...
- That open-source community service is a durable frame for this kind of work
- That the governance principles here can eventually earn participation
- That the joke-as-filter creates the right room
...
This is the entryway. The research is in the research repos. The governance has to earn trust. The rules are not handed down.

Check [ROADMAP.md](ROADMAP.md) for what comes next.
