...
No prophets.
No sacred texts.
No claims that cannot be questioned.
No revelation without receipts.

---

## What dogma looks like here

Dogma in a project like this tends to arrive in a few specific forms:
...
**Sacred terminology.** When a concept becomes so central to a community's identity that questioning it feels like an attack on the community rather than an inquiry about the concept. That is the moment the concept has become dogma.
...
## The line between principle and dogma

Some things in this ecosystem are treated as load-bearing: positive-sum coordination is better than zero-sum, transparency is better than obscurity, open rulemaking is better than closed authority.

These are principles. They can be questioned. The questioning is encouraged.

If questioning them gets someone pushed out, they have become dogma.
